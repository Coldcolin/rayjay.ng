...
const projects = [
  ...
  },
  {
    ...
    image: "/pipeline-construction-trench.png",
  },
];
...
const WHATSAPP_PHONE = "2348151201017";
const WHATSAPP_PREFILL =
  "Hello, I'd like to inquire about your services.";
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_PHONE}?text=${encodeURIComponent(WHATSAPP_PREFILL)}`;
...
function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lift transition hover:scale-105 hover:bg-[#20BD5A] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sea-500"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
            ...
            <div className="mt-10">
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {service.galleryImages.map((image) => (
                  <div
                    key={image.src}
                    className="overflow-hidden rounded-2xl border border-ink-900/10 shadow-soft"
                  >
                    <img
                      src={image.src}
                      alt={image.alt}
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div>
                ...
                <h2 className="mt-4 text-3xl font-semibold uppercase tracking-[0.08em] text-white">
                  Training, inspection, supplies, and special services
                </h2>
              </div>
